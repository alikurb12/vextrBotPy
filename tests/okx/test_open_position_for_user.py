...
from backend.exchange_apis.okx.services.open_position import open_position # замените на правильный путь

async def test_your_function():
    print("🧪 Тестирование вашей функции open_position")
    print("=" * 50)
    ...
    result = await open_position(api_key, secret_key, passphrase, "ETH-USDT-SWAP", "long", "0.1")
