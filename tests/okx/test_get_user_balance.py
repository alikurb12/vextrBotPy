...
from backend.exchange_apis.okx.services.get_balance import get_balance  # замените на правильный путь
...
async def test_your_function():
    ...
    result = await get_balance(api_key, secret_key, passphrase)
