...
from backend.exchange_apis.okx.services.set_leverage import set_leverage # замените на правильный путь

async def test_your_function():
    print("🧪 Тестирование вашей функции set_leverage")
    print("=" * 50)
    ...
    result = await set_leverage(api_key, secret_key, passphrase, "ETH-USDT-SWAP", "short")
